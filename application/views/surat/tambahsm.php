			...
			<div class="row">
				<div class="col-lg">
					<div class="p-5">
						...
						<form method="post" action="<?= base_url('surat/tambahsm'); ?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								<input type="text" class="form-control" id="asal_surat" name="asal_surat" placeholder="Asal Surat" value="<?= set_value('asal_surat'); ?>" autocomplete="off">
