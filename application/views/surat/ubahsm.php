<div class="container-fluid">
	...
	<div class="row">
		<div class="col-lg-6">
			<div class="p-5">
				<div>
					<h1 class="h4 text-gray-900 mb-4">Ubah Surat Masuk</h1>
				</div>
				<form method="post" action="<?= base_url('surat/ubahsm/' . $surat->id); ?>" enctype="multipart/form-data">
					...
					<div class="form-group">
						<input type="text" class="form-control" id="asal_surat" name="asal_surat" placeholder="Asal Surat" value="<?= $surat->asal_surat; ?>">
