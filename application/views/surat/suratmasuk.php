...
<div class="container-fluid">
	...
	<div class="col-md-3 mb-4">
		<div class="card border-left-success shadow h-100 py-2 row">
			<div class="card-body">
	...
	<a href="<?= base_url('surat/tambahsm'); ?>" class="btn btn-primary mb-4"><i class="fas fa-plus-square"></i> Surat Masuk</a>

	<!-- Tampilan Daftar Tahun -->
	<div class="row">
		<div class="col-lg-10">
			<?php foreach ($years as $year) : ?>
				<a href="<?= site_url('surat/showSuratByYear/' . $year['tahun']); ?>" class="btn btn-warning mr-3 mb-3"><?= $year['tahun']; ?></a>
			<?php endforeach; ?>
		</div>
	</div>
</div>
